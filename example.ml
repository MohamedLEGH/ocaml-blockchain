...
let miner_address = Some "0x4"
let block2 = { block1 with timestamp = Some 0.; miner_address }
...
let tx1json = yojson_of_transaction tx1;;

print_endline (Yojson.Safe.to_string tx1json)
